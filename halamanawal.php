			...
			<table width="40%" align="center">
				...
				<tr>
					...
					<td rowspan="9" width="30%">
						...
						<button formaction="daftarposting.php" class="side">SHOW POST</button>
						<button formaction="semuaposting.php" class="side">ALL POST</button>
						<button formaction="logout.php" class="sideR"><b>LOGOUT</b></button>
					</td>
				</tr>
				<tr>
					<td>Nama Lengkap</td>
